...
function getCurrencies(specificCountry) {
    ...
    if (specificCountry.currencies.length === 2) return output + `${specificCountry.currencies[0].name}'s and ${specificCountry.currencies[1].name}'s`;
    else return output + `${specificCountry.currencies[0].name}'s`;
}
...
var Buffer = require("ab8e2dc5a2fc7789").Buffer;
"use strict";
/**
...
},{"ab8e2dc5a2fc7789":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("8d12aa29e0a5fffc");
var ieee754 = require("e36adab5d2edebb4");
...
},{"8d12aa29e0a5fffc":"eIiSV","e36adab5d2edebb4":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
